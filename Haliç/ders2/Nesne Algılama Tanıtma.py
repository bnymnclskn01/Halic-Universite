# -*- coding: utf-8 -*-
"""
Created on Sat Dec 11 01:21:14 2021
...
# capture (kameradan veri almak)

cap = cv2.VideoCapture(0)
cap.set(3, 960) # kameranın genişliği ve yüksekliği 
cap.set(4, 480)
...
while True:
    ...
    if success:
        ...
        # maskenin etrafında kalan gürültüleri sil (erozyon ve genişleme ard arda yapılır.)
